    ...
    return (
        <div id="card">
            ...
            <div className={classes.cardImage}>
                <div className={[classes.block, classes.pulsate].join(' ')}></div>

                <svg className={classes.bpo} width="84px" height="63px" x="50%" y="50%" viewBox="0 0 84 63" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={classes.cardContent}>
                <div className={[classes.block2, classes.pulsate].join(' ')}>
                </div>
                <div className={[classes.block3, classes.pulsate].join(' ')}>
                </div>
                <div className={[classes.bircle, classes.pulsate].join(' ')}>
                </div>
